...
public:
	...
	bool insertLRC(int index, char *lrc, int time);
	bool deleteLRC(int index);

	/* custom function */
	bool getLRCFromGOMServer(WCHAR *hash, WCHAR *title, WCHAR *artist, WCHAR *album, bool line1, bool line2, bool line3,bool depart);
	void html_entity_decode(WCHAR *str);
	bool getLRCFromAlsongServer(WCHAR *hash, bool line1, bool line2, bool line3,bool depart);
	bool setTag(WCHAR *data, WCHAR *tag, WCHAR *dPacket);
	bool getLRCFromAlsongServerTA(WCHAR *strTitle, WCHAR *strArtist, bool line1, bool line2, bool line3,bool depart);
private:
public:
